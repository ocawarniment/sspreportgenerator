...
function updateReport() {
	...
	storage.get(null, function (result) {
		...
		document.getElementById('comp_alg1').innerText = `${result.maxscore_alg1 == '' ? 'N/A' : result.maxscore_alg1} - ${result.comp_alg1_attempts} attempt(s)`;
		document.getElementById('comp_eng2').innerText = `${result.maxscore_eng2 == '' ? 'N/A' : result.maxscore_eng2} - ${result.comp_eng2_attempts} attempt(s)`;
